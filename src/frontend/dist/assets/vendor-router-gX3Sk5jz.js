...
import { r as reactExports, j as jsxRuntimeExports, R as React, c as reactDomExports } from "./vendor-react-CYgLKadW.js";
import { i as invariant, w as withSelectorExports, f as warning } from "./vendor-DT3DREzx.js";
...
const Match = reactExports.memo(function MatchImpl({
  ...
  const routeNotFoundComponent = route.isRoot ? (
    ...
    route.options.notFoundComponent ?? ((_a2 = router.options.notFoundRoute) == null ? void 0 : _a2.options.component)
...
const MatchInner = reactExports.memo(function MatchInnerImpl({
  ...
  if (match._displayPending) {
    throw (_a2 = router.getMatch(match.id)) == null ? void 0 : _a2._nonReactive.displayPendingPromise;
  }
  if (match._forcePending) {
    throw (_b2 = router.getMatch(match.id)) == null ? void 0 : _b2._nonReactive.minPendingPromise;
  }
  if (match.status === "pending") {
    ...
    throw (_c2 = router.getMatch(match.id)) == null ? void 0 : _c2._nonReactive.loadPromise;
  }
  ...
  if (match.status === "redirected") {
    ...
    throw (_d2 = router.getMatch(match.id)) == null ? void 0 : _d2._nonReactive.loadPromise;
  }
...
const Outlet = reactExports.memo(function OutletImpl() {
  ...
  const childMatchId = useRouterState({
    select: (s) => {
      ...
      return (_a2 = matches[index + 1]) == null ? void 0 : _a2.id;
    }
  });
